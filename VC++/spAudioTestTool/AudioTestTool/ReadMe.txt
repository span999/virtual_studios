================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : AudioTestTool Project Overview
===============================================================================

The application wizard has created this AudioTestTool application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your AudioTestTool application.

AudioTestTool.vcproj
...
AudioTestTool.h
    ...
    project specific headers and declares the CAudioTestToolApp application class.

AudioTestTool.cpp
    This is the main application source file that contains the application
    class CAudioTestToolApp.
...
AudioTestToolDlg.h, AudioTestToolDlg.cpp - the dialog
    These files contain your CAudioTestToolDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named AudioTestTool.pch and a precompiled types file named StdAfx.obj.
